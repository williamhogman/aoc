...
def part1(xs):
    ...
    lz_door = find_lz(7, pk_door)
    lz_card = find_lz(7, pk_card)

    key = apply_txform(pk_door, lz_card)
    key2 = apply_txform(pk_card, lz_door)
    print(key, key2)
