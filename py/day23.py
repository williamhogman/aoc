...
after cup 1?
Your puzzle input is 253149867.
...
@e.part1()
def part1(xs):
    c = [int(c) for c in str(253149867)]
    for x in range(100):
        c = round(c)
...
@e.part2()
def part2(xs):
    xs = [int(c) for c in str(253149867)]
    for x in range(max(xs), 1000000):
        xs.append(x+1)
    cur = xs[0]
    ring = {}
